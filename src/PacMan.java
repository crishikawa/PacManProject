...
public class PacMan extends JPanel implements ActionListener, KeyListener{
    ...
    public void draw(Graphics g){
        ...
        if(gameOver){
            ...
            g.drawString("High Score: " + highScore, (columnCount - 6) * tileSize, tileSize/2);
        } else {
    ...
    public void move(){
        ...
        if(pacman.x == 0){
            pacman.x = columnCount * tileSize - tileSize;
        } else if(pacman.x == columnCount * tileSize - tileSize){
            pacman.x = 0;
        }
        ...
        for(Block ghost : ghosts){
            ...
            if(ghost.x == 0){
                ghost.x = columnCount * tileSize - tileSize;
            } else if(ghost.x == columnCount * tileSize - tileSize){
                ghost.x = 0;
            }  
